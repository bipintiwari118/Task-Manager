<x-app-layout>
    ...
    <div class="">
        <form action="{{ route('permission.update',$permission->id) }}" method="post" enctype="multipart/form-data">
            ...
            <button
                class="bg-blue-600 text-white px-[20px] py-[8px] rounded-md  mb-[30px] float-right mr-[50px] hover:bg-blue-800">Update Permission</button>
                ...
                <div class="h-auto w-full flex justify-evenly">
                    <div class="w-3/5 h-auto shadow-md p-[20px] flex flex-col items-center gap-y-[30px]">
                        <div class="w-full flex flex-col gap-y-3">
                            ...
                            <input type="text" name="name" id="name" class="w-full rounded-md" value="{{ $permission->name }}">
                            @error('name')
